...
export default {
  ...
  data() {
    return {
      ...
      token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ODYsImFwcF91c2VyX2lkIjoiMTgzMiIsImNsaWVudF9pZCI6NTYsInN0YXR1cyI6Im5ldyIsImFwcF9pZCI6MSwiaWF0IjoxNzEwODMyNDk2LCJleHAiOjE3MTA5MTg4OTZ9.8h5KwLTx5A1srdTXSoKoLL1PnOrVS5sWpx96JFZLC-0",
      items: [],
      filterText: "",
      queryFilter: "",
      showModal: false,
